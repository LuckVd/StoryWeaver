...
|---|---|---|---|---|---|---|---|---|---|---|---|
| G01 | | Phase 1: MVP | 基本可用的写作工具 | in_progress | | | pending | not_started | | | 8/12 子目标完成 |
...
| G01 | G01-S10 | 章节列表 + 编辑器 | ChapterList 页 + ChapterEditor 页 (Tiptap + Markdown 互转) | planned | G01-S09 | | pending | not_started | | | |
